...
PS_COLS = ["mlbam_id", "name", "team", "throws", "owner", "date", "gamePk", "home", "opp", "venue", "sp_source", "opp_woba_vs_hand", "opp_k_vs_hand", "park_runs", "temp_f", "wind_out", "precip_prob", "local_start",
           "base_gs", "pts_gs_2026", "GS", "pitching_plus", "stuff_plus", "xera", "k_percent", "woba_30", "gs_30", "f_opp", "f_park", "f_wx", "k_bonus", "exp_pts", "two_start", "week_pts", "active", "status", "role", "ip_gs", "n_starts", "last5_pts", "last3_pts", "ip_start_3", "ip_mix", "velo_30", "dvelo", "whiff_30", "dwhiff", "csw_30", "relief_after_start", "days_since_start", "pl_tier", "pl_note", "cbs"]
